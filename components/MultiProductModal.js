                            ...
                            <div className={styles.ant_modal_body}>
                                <div className={styles.jYCyV}>
                                    ...
                                    <div className={styles.hRmKiD}>
                                        ...
                                        <textarea className={[styles.ant_input + " " + styles.textarea]} spellCheck="false"></textarea>
                                    </div>                                
                                    <div className={styles.JwezC} style={{marginTop: "30px"}}>
                                        <div className={[styles.ant_btn_group + " " + styles.ant_btn_group_lg + " " + styles.ant_dropdown_button]}>
                                            <button disabled="" type="button" className={[styles.ant_btn + " " + styles.ant_btn_primary]} onClick={() => handleImport()}>
                                                <span>Import</span>
                                            </button>
                                        </div>
                                    </div>
