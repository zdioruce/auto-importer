import styles from './SingleDraftDeleteModal.module.scss'

export default function SingleDraftDeleteModal({show, handleClose, handleDelete}) {
    return show ? (
        <div>
                ...
                <div className="ant-modal-content">
                    ...
                    <div className="ant-modal-body">
                        <div width="340" className={styles.iMpmEY}>
                            <h2>Delete Draft</h2>
                            <p className="semi-bold">You are about to delete Draft. Are you sure you want to Continue?</p>
                            <div>
