...
export default function DraftAllImportModal({show, handleCancel, handleOk, count}) {
    return show ? (
        <div>
            ...
            <div tabIndex="-1" className="ant-modal-wrap ant-modal-centered" role="dialog">
                ...
                <div className="ant-modal-content">
                    <button type="button" aria-label="Close" className="ant-modal-close" onClick={handleCancel}>
                    ...
                    <div className="ant-modal-body">
                        <div width="340" className={styles.iMpmEY}>
                            ...
                            <p className="semi-bold">You are about to import {count > 1? count + ' drafts': 'a draft'}. Are you sure you want to Continue?</p>
                            <div>
                            <button type="button" className="ant-btn ant-btn-link ant-btn-lg" onClick={handleCancel}>
                                <span>No, Cancel</span>
                            </button>
                            <button type="button" className="ant-btn jwxKrG ant-btn-primary ant-btn-lg" onClick={handleOk}>
