import styles from '../styles/AddProductsDropDown.module.scss'

export default function AddProductsDropDown({show, handleMenu}) {
    return show ? (
        <div style={{position: "absolute", top: "0px", left: "0px", width: "100%"}}>
            <div>
                <div className={styles.ant_dropdown} style={{position: "absolute", left: "20px", top: "126px"}}>
                    <ul className={styles.ant_dropdown_menu}>
                        <li className={styles.ant_dropdown_menu_item} onClick={() => handleMenu(1)}>
                            <div className={styles.bxZhDT}>
                                ...
                                <div>
                                    <p className={styles.bold}>Single Product</p>
                                    <p>Import one product</p>
                                </div>
                            </div>
                        </li>
                        <li className={styles.ant_dropdown_menu_item} onClick={() => handleMenu(2)}>
                            <div className={styles.bxZhDT}>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div>
                                    <p className={styles.bold}>Multiple Products</p>
